"""Load the clinical organism list: names grouped by category, from a YAML file.
...
``organisms.list_file`` in the configuration.
"""
...
def load_organism_list(cfg: Config) -> OrganismList:
    """Load the organism list named by ``organisms.list_file``, or the packaged starter list."""
